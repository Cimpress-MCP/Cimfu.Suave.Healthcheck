...
let website = "/Cimfu.Suave.Healthcheck"

let githubLink = "http://github.com/Cimpress-MCP/Cimfu.Suave.Healthcheck"

// Specify more information about your project
let info =
  [ "project-name", "Cimfu.Suave.Healthcheck"
    "project-author", "Marcus Griep"
    "project-summary", "A pluggable healthcheck endpoint for the Suave functional web server."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Cimfu.Suave.Healthcheck" ]
